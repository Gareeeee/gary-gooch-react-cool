        ...
        <div className="two-column">
          ...
          <div className="image-uploaders three-column">
              ...
              <div className='image-removal-link'>
                <a onClick={() => this.deleteImage('thumb_image')}>Remove Picture?</a>
              </div>
              </div>
              ):(
              <DropzoneComponent
            ...
            >
              ...
              <div className='image-removal-link'>
                <a onClick={() => this.deleteImage('banner_image')}>Remove Picture?</a>
              </div>
              </div>
              ):(
            <DropzoneComponent
            ...
            {this.state.logo_url && this.state.editMode ?(
              ...
              <div className='image-removal-link'>
                <a onClick={() => this.deleteImage('logo')}>Remove Picture?</a>
              </div>
              </div>
              ):(
            <DropzoneComponent
